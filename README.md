...
### 1. Character Generation (`js/generators/character-generator.js`)
...
### 2. Name Generation (`js/generators/name-generator.js`)
...
### 3. Backstory Generation (`js/generators/backstory-generator.js`)
Backstories are generated using a template system:
-   **Data Pools**: Lists of places, origins, skills, and reputation claims are stored in `js/data/backstory-dataset.js`.
...
-   `js/generators/`: Contains generator logic (`character-generator.js`, `name-generator.js`, `backstory-generator.js`).
-   `js/data/`: Contains static data pools (`backstory-dataset.js`).
-   `js/core/`: Contains rendering logic (`renderer.js`).
